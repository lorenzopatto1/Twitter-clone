...
export function MainHeader() {
  ...
  return (
      <Flex position="sticky" h="52px" top="-0.5" zIndex="3" w="100%" bg={bg}>
        <Flex h="100%" w="100%" zIndex="2" cursor="pointer">
            <Flex w="100%" borderBottomWidth="1px" paddingX="4" align="center">
                <Flex maxW="1000px" w="100%" marginX="auto" h="53px" justify="center" align="center">
                  <Flex align="center" flexShrink={1} h="100%" flexGrow={1}>
                    <Flex align="flex-start">
                      <Text d="flex" as="h2" h="100%" fontSize="20" color={color} minW="0">
                        <Text as="span" overflowWrap="break-word" fontWeight="bold" minW="0">Página Inicial</Text>
                      </Text>
                    </Flex>
                  </Flex>
                </Flex>
              <Flex w="36px" h="36px" align="center" justify="center" borderRadius="50%" _hover={{ background: '#1d9bf019'}}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
